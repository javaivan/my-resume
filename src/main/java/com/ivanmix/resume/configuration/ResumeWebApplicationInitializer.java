...
import com.ivanmix.resume.filter.ResumeFilter;
import com.ivanmix.resume.listener.ApplicationListener;
...
public class ResumeWebApplicationInitializer implements WebApplicationInitializer {
    ...
    private WebApplicationContext createWebApplicationContext(ServletContext container) {
        ...
        ctx.scan("com.ivanmix.resume.configuration");
        ...
        return new ConfigurableSiteMeshFilter() {
            ...
            protected void applyCustomConfiguration(SiteMeshFilterBuilder builder) {
                builder
                        ...
                        .addDecoratorPath("/edit/*", 		 "/WEB-INF/template/edit-template.jsp")
